 ...
 * @author ScrapsBits
 */
public interface AppBootCommands {
	/**
	...
	/**
	 * Get how many unique boot modes are supported by the application.
	 *
	 * @return Returns the number of unique boot modes supported by the application.
	 */
	int getBootModeCount();

	/**
	 * Get how many commands are supported by the application.
	 *
	 * @return Returns the number of commands supported by the application.
	 */
	int getCommandCount();

	/**
	 * Get how many commands are used by the provided boot mode.
	 *
	 * @param  bootMode The boot mode checked.
	 * @return          Returns the number of commands linked to the provided boot mode.
	 */
	int getCommandCount(BootMode bootMode);
